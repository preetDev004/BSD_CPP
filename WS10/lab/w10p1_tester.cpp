...
int main() {
   ...
   listArrayElements("All the cars:", C, Cres.size());
   ...
   if (search(Cres, C, Cres.size() , "Tesla")) {
   ...
   listArrayElements("All students:", S, Sres.size());
   ...
   if (search(Sres, S, Sres.size(), 4.0)) {
   ...
   listArrayElements("All employees:", E, Eres.size());
   ...
   if (search(Eres, E, Eres.size(), 111)) {
   ...
   if (search(Eres, E, Eres.size(), 555)) {
      cout << Eres.size() << " match" << (Eres.size() == 1 ? "" : "es") << " found:" << endl;
      for (int i = 0; i < Eres.size(); i++) {
         cout << (i + 1) << ": " << Eres[i] << endl;
      }
